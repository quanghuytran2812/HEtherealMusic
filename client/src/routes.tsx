...
const ListAlbumDetail = lazy(() => import("@/pages/public/ListAlbumDetail"));
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: pathname.publics.listAlbumDetail,
                element: <Suspense fallback={<div>Loading...</div>}><ListAlbumDetail /></Suspense>,
              },
            ],
          },
        ],
